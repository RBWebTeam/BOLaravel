...
<tr>
<td><a href="#" style="color: black;" onclick="Ticket_comment_fn('{{$val->TicketRequestId}}')" >{{$val->TicketRequestId}}</a></td>
...
<div class="modal-footer">
<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
<button type="button" class="btn btn-primary" id="TicketRequest_Id_save">Save</button>
</div>
</div>
</div>
</div>
